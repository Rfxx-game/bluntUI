...
local Utility = {}
local Objects = {}
function blunt:DraggingEnabled(frame, parent)
...
function blunt.CreateLib(bluName, themeList)
    ...
    local selectedTab 
    bluName = bluName or "Library"
    table.insert(blunt, bluName)
    for i,v in pairs(game.CoreGui:GetChildren()) do
        if v:IsA("ScreenGui") and v.Name == bluName then
            v:Destroy()
        end
    end
    ...
    blunt:DraggingEnabled(MainHeader, Main)
    ...
    function blunt:ChangeColor(prope,color)
